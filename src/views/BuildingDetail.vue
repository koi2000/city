...
import {buildingDetail} from "@/api/city";
...
export default {
  ...
  methods: {
    ...
    initControls() {
      ...
      this.vr_controls = new OrbitControls(
          this.vr_camera,
          this.vr_renderer.domElement
      );
      // 使动画循环使用时阻尼或自转 意思是否有惯性
        ...
        series: [
          {
            ...
            data: [
              {value: this.infoList.malecount, name: "男性人数"},
              {value: this.infoList.femalecount, name: "女性人数"},
            ],
          },
        ],
      };
