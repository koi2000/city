...
// 加载警察局
// export const initPolice = (scene) => {
//   return new GLTFLoader()
//     .setPath("/static/obj/city_police_station/")
//     .load("scene.gltf", (gltf) => {
//       const police = gltf.scene;
//       police.scale.set(55, 55, 55);
//       police.traverse((res) => {
//         res.name = "policeStation";
//         if (res.type === "Mesh") {
//           res.material.emissive = res.material.color;
//           res.material.emissiveMap = res.material.map;
//         }
...
export const initCinema = (scene) => {
  return new GLTFLoader()
    ...
    .load("scene.gltf", (gltf) => {
      ...
      cinema.traverse(function (child) {
        child.name = "cinema";
        if (child.type === "Mesh") {
          child.material.emissive = child.material.color;
          child.material.emissiveMap = child.material.map;
